    ...
    <PopoverTrigger as-child>
      ...
      <PopoverContent outline="~ 1.5 neutral-200" rounded-8 bg-white fixed bottom-16 right-16 w-280 shadow-lg z-50 f-p-md>
        ...
        <div f-mb-md>
          ...
          <div flex="~ col gap-4">
            <button v-for="availableLocale in availableLocales" :key="availableLocale.code" flex="~ items-center gap-8" text="f-sm neutral-800 hover:neutral-900" bg="hover:neutral-50" :class="{ 'bg-neutral-100 font-semibold': locale === availableLocale.code }" outline-none rounded-6 cursor-pointer transition-colors f-p-2xs @click="changeLocale(availableLocale.code)">
        ...
        <div border="t neutral-200" f-pt-md>
          ...
          <p v-if="!useLuganoLocation && isFromQueryParams" text="f-xs neutral-600" m-0 f-mt-xs>
