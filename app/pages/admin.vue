              ...
              >
                ...
                <td px-8 py-8 max-w-300>
                  <div flex="~ col">
                    ...
                    <span text="neutral-800 f-2xs" mt-2>{{
                      location.address
                    }}</span>
                  </div>
                </td>
                ...
                <td px-8 py-8 whitespace-nowrap>
                  ...
                  >
                    <Icon
                      name="i-nimiq:star"
                      size-12
                      text="neutral-500 group-hocus:gold"
                      transition-colors
                    />
                    {{ location.rating }}
                  </span>
                ...
                <td px-8 py-8 whitespace-nowrap>
                  <Icon
                    v-if="getSourceIcon(location.source)"
                    :name="getSourceIcon(location.source)!"
                    size-16
                    op="50 group-hocus:100"
                    grayscale="~ group-hocus:0"
                    transition-all
                  />
                  <span
                    v-else
                  ...
                  <template v-if="location.hoursStatus">
                    <div flex="~ items-center gap-4">
                      <span
                        ...
                        text="10px"
                      >
                        {{ $t(location.hoursStatus.status.messageKey) }}
                      </span>
                        ...
                        <TooltipPortal>
                          ...
                          >
                            <div text="f-xs neutral-700" font-mono>
                              <div
                                v-for="(line, index) in location.hoursStatus
                                  .formattedHours"
                                :key="index"
                              >
                                {{ line }}
                ...
                <td px-8 py-8>
                  <div flex="~ col gap-2 items-start">
                    <button
                      type="button"
                      text="f-2xs neutral-600 hover:neutral-900 left"
                      ...
                      whitespace-nowrap
                      transition-colors
                      @click="copyToClipboard(location.uuid, 'UUID copied')"
                    >
                      {{ location.uuid }}
                    </button>
                    <button
            ...
            <PaginationList v-slot="{ items }" flex="~ items-center gap-4">
              <PaginationPrev as-child>
                <button
                  ...
                  bg="neutral-100 hover:neutral-200 disabled:neutral-50"
