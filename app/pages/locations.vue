        ...
        <table w-full text="f-xs left" border-collapse>
          ...
          <tbody>
            <tr v-for="location in locations" :key="location.uuid" bg="white hover:neutral-50" border-b="1 neutral-200" transition-colors>
              ...
              <td px-8 py-8>
                <button type="button" text="f-xs neutral-500 hover:neutral-900" bg="transparent hover:neutral-100" font-mono px-6 py-2 rounded-4 cursor-pointer whitespace-nowrap transition-colors @click="copy(location.uuid)">
              ...
              <td px-8 py-8>
                <DropdownMenuRoot>
                  ...
                  <DropdownMenuContent border="1 neutral-200" p-4 rounded-8 bg-white min-w-160 shadow-lg z-50>
                    ...
                    <DropdownMenuItem as-child>
                      <button type="button" flex="~ items-center gap-8" text="f-sm neutral-800 hover:neutral-900" bg="hover:neutral-50" px-8 py-6 outline-none rounded-4 w-full cursor-pointer transition-colors @click="() => copy(location.uuid)">
                        <Icon name="i-tabler:copy" size-16 />
                        Copy UUID
                      </button>
                    </DropdownMenuItem>
                    <DropdownMenuItem as-child>
                      <button type="button" flex="~ items-center gap-8" text="f-sm neutral-800 hover:neutral-900" bg="hover:neutral-50" px-8 py-6 outline-none rounded-4 w-full cursor-pointer transition-colors @click="() => copy(`${location.lat}, ${location.lng}`)">
